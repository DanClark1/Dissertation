...
# save model
agent.save_checkpoint("", ckpt_path="checkpoints/sac_checkpoint_{}_{}".format(args.env_name, ""))
agent.load_checkpoint(ckpt_path="checkpoints/sac_checkpoint_{}_{}".format(args.env_name, ""))
env.close()
