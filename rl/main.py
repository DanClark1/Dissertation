...
def main():
    ...
    # -------------------------------
    if args.use_moe:
        agent = MT_SAC(obs_dim, action_space, writer, args, num_experts=(10 if args.do_50 else 6), num_tasks=(50 if args.do_50 else 10), task_names=task_names)
    ...
    if args.eval_variance:
        ...
        means, variances, angular_variances, mean_norms, weights, affinities = agent.policy.calculate_task_variance(task_names)
